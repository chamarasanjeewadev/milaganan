...
export function Header({ isMobilePreviewVisible, setIsMobilePreviewVisible }: HeaderProps) {
  return (
    <header className="bg-white border-b border-gray-200 px-4 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          {isMobilePreviewVisible ? <FileEdit className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
